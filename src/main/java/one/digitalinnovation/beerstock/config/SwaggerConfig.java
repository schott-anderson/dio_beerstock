...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Anderson Schott";
    private static final String CONTACT_GITHUB = "https://gtihub.com/schott-anderson";
    private static final String CONTACT_EMAIL = "schott.anderson@hotmail.com";
